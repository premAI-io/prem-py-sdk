...
class TestRecommendations:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_generate(self, client: PremAI) -> None:
        response = client.recommendations.with_raw_response.generate(
            snapshot_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_streaming_response_generate(self, client: PremAI) -> None:
        with client.recommendations.with_streaming_response.generate(
            snapshot_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
...
class TestAsyncRecommendations:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_raw_response_generate(self, async_client: AsyncPremAI) -> None:
        response = await async_client.recommendations.with_raw_response.generate(
            snapshot_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_streaming_response_generate(self, async_client: AsyncPremAI) -> None:
        async with async_client.recommendations.with_streaming_response.generate(
            snapshot_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
