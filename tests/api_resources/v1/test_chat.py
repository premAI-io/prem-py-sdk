...
from premai.types.v1 import ChatRetrieveModelsResponse, ChatCreateCompletionResponse
...
class TestChat:
    ...
    def test_method_create_completion(self, client: Premai) -> None:
        chat = client.v1.chat.create_completion(
            frequency_penalty=-2,
    ...
    def test_raw_response_create_completion(self, client: Premai) -> None:
        response = client.v1.chat.with_raw_response.create_completion(
            frequency_penalty=-2,
            max_completion_tokens=1,
            messages=[{"role": "system"}],
            model="model",
    ...
    def test_streaming_response_create_completion(self, client: Premai) -> None:
        with client.v1.chat.with_streaming_response.create_completion(
            frequency_penalty=-2,
            max_completion_tokens=1,
            messages=[{"role": "system"}],
            model="model",
    ...
    def test_method_retrieve_internal_models(self, client: Premai) -> None:
        chat = client.v1.chat.retrieve_internal_models()
    ...
    def test_method_retrieve_models(self, client: Premai) -> None:
        chat = client.v1.chat.retrieve_models()
    ...
    def test_raw_response_retrieve_models(self, client: Premai) -> None:
        response = client.v1.chat.with_raw_response.retrieve_models()
    ...
    def test_streaming_response_retrieve_models(self, client: Premai) -> None:
        with client.v1.chat.with_streaming_response.retrieve_models() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncChat:
    ...
    async def test_method_create_completion(self, async_client: AsyncPremai) -> None:
        chat = await async_client.v1.chat.create_completion(
            frequency_penalty=-2,
            max_completion_tokens=1,
            messages=[{"role": "system"}],
            model="model",
    ...
    async def test_raw_response_create_completion(self, async_client: AsyncPremai) -> None:
        response = await async_client.v1.chat.with_raw_response.create_completion(
            frequency_penalty=-2,
            max_completion_tokens=1,
            messages=[{"role": "system"}],
            model="model",
    ...
    async def test_streaming_response_create_completion(self, async_client: AsyncPremai) -> None:
        async with async_client.v1.chat.with_streaming_response.create_completion(
            frequency_penalty=-2,
            max_completion_tokens=1,
            messages=[{"role": "system"}],
            model="model",
    ...
    async def test_method_retrieve_internal_models(self, async_client: AsyncPremai) -> None:
        chat = await async_client.v1.chat.retrieve_internal_models()
        assert_matches_type(object, chat, path=["response"])

    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_retrieve_internal_models(self, async_client: AsyncPremai) -> None:
        response = await async_client.v1.chat.with_raw_response.retrieve_internal_models()
    ...
    async def test_streaming_response_retrieve_internal_models(self, async_client: AsyncPremai) -> None:
        async with async_client.v1.chat.with_streaming_response.retrieve_internal_models() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_retrieve_models(self, async_client: AsyncPremai) -> None:
        chat = await async_client.v1.chat.retrieve_models()
        assert_matches_type(ChatRetrieveModelsResponse, chat, path=["response"])

    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_retrieve_models(self, async_client: AsyncPremai) -> None:
        response = await async_client.v1.chat.with_raw_response.retrieve_models()
    ...
    async def test_streaming_response_retrieve_models(self, async_client: AsyncPremai) -> None:
        async with async_client.v1.chat.with_streaming_response.retrieve_models() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
